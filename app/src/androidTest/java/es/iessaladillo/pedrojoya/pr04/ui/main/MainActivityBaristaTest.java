...
public class MainActivityBaristaTest {
    ...
    public void shouldAddressEditTextShowErrorWhenInvalidData() {
        writeTo(R.id.lblAddress, "");
        assertError(R.id.lblAddress, R.string.main_invalid_data);
    ...
    public void shouldAddressEditTextShowNoErrorWhenValidData() {
        writeTo(R.id.lblAddress, "test");
        assertAny(withId(R.id.lblAddress), hasErrorText(isEmptyOrNullString()));
    }
